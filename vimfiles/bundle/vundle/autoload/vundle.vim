...
func! vundle#rc(...) abort
  ...
  " by kwc vim 설치폴더 vimfiles에 위치하길 원해서 임의 수정. 
  if has("gui_running") 
        let g:bundle_dir = len(a:000) > 0 ? expand(a:1, 1) : expand('$VIM/vimfiles/bundle', 1)
  else
        let g:bundle_dir = len(a:000) > 0 ? expand(a:1, 1) : expand('$HOME/.vim/vimfiles/bundle', 1)
  endif
  let g:vundle_log = []
